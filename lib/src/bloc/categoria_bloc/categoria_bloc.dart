...
class CategoriaBloc extends Bloc<CategoriaEvent,CategoriaState>{
  ...
  Stream<CategoriaState> _mapLoadCategoriaToState() async*{
    ...
    try {
      _categoriaSubscription = _categoriaRepository.getCategorias().listen(
        (categorias) =>add(CategoriaUpdated(categorias))
      );
    } catch (_) {
  ...
  Stream<CategoriaState> _mapCategoriaUpdatedToState(CategoriaUpdated event) async*{
